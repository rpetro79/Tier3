...
namespace SEP3.DbSeeder
{
    public class DbSeeding
    {
        ...
        public static void init(UserContext context)
        {
            ...
            context.credentials.Add(new DbCredentials { Username = cr.Username, Password = cr.Password });
            context.credentials.Add(new DbCredentials { Username = cr2.Username, Password = cr2.Password });
            context.credentials.Add(new DbCredentials { Username = cr3.Username, Password = cr3.Password });
            context.credentials.Add(new DbCredentials { Username = cr4.Username, Password = cr4.Password });
            context.SaveChanges();
